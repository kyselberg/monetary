					...
					<div class="form-control">
						...
						<div class="flex items-center gap-2">
							<input
								...
								id="color"
								name="color"
								class="h-12 w-12 rounded border-2 border-base-300"
...
{#if showDeleteModal}
	<div class="modal-open modal">
		<div class="modal-box">
			<h3 class="text-lg font-bold text-error">Delete Category</h3>
			{#if data.expenseCount > 0}
				<div class="mb-4 alert alert-warning">
					...
					<div>
						...
						<div class="text-sm">
							This category has <strong>{data.expenseCount}</strong> associated expense{data.expenseCount ===
							1
								? ''
								: 's'}. You must delete or reassign all expenses before deleting this category.
						</div>
					</div>
				</div>
			...
			{:else}
				<p class="py-4">
					Are you sure you want to delete the category "<strong>{data.category.name}</strong>"? This
